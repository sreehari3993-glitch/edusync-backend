...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // No token present — let Spring Security handle (will reject if route is protected)
        ...
        try {
            ...
            // Invalid token — don't set authentication, let request proceed unauthenticated
